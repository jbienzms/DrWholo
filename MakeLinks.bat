...
ECHO ===============================================================================
ECHO.
XCOPY /Y /Q %HoloKitSource%\Assets\*.* Unity\DrWholo\Assets
ECHO.
...
ECHO ===============================================================================
ECHO.
mklink /J Unity\DrWholo\Assets\HoloToolkit %HoloKitSource%\Assets\HoloToolkit
ECHO.
...
ECHO ===============================================================================
ECHO.
mklink /J Unity\DrWholo\Assets\Adept %AdeptSource%\Lib\Unity\Assets\Adept
ECHO.
